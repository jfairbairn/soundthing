...
final class RequestHandlers {
   ...
   * move
   * 
   * @version $Id: RequestHandlers.java 1045302 2010-12-13 18:57:24Z hossman $
   * @since solr 1.2
   */
  private static final class LazyRequestHandlerWrapper implements SolrRequestHandler, SolrInfoMBean
  {
    ...
    public String getSourceId() {
      String rev = "$Id: RequestHandlers.java 1045302 2010-12-13 18:57:24Z hossman $";
      if( _handler != null ) {
